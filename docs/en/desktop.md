...
The current repository version is **0.11.1**. Desktop and the Python package use the same version number and release tag. Desktop installers are published on GitHub Releases; the Python package is published on PyPI.
